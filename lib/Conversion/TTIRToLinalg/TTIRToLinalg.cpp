...
public:
  ...
  matchAndRewrite(TTIROpTy op, typename TTIROpTy::Adaptor adaptor,
    ...
    auto result =
        tosa::CastOp::create(rewriter, op.getLoc(), resultType, boolResult);
...
public:
  ...
  matchAndRewrite(TTIROpTy op, typename TTIROpTy::Adaptor adaptor,
    ...
    // Convert boolean result to original type using cast.
    auto result =
        tosa::CastOp::create(rewriter, op.getLoc(), resultType, notResult);
...
public:
  ...
  matchAndRewrite(ttir::CosOp op, OpAdaptor adaptor,
    ...
    auto piOver2Const =
        tosa::ConstOp::create(rewriter, op.getLoc(), piOver2Type, piOver2Attr);
...
public:
  ...
  matchAndRewrite(TTIROpTy op, typename TTIROpTy::Adaptor adaptor,
    ...
    auto logicalResult =
        TosaOpTy::create(rewriter, op.getLoc(), boolType, boolLhs, boolRhs);

    // Convert boolean result back to original type using cast.
    auto result =
        tosa::CastOp::create(rewriter, op.getLoc(), resultType, logicalResult);
