  ...
  permuteInnerDims(ttir::PermuteOp op, typename ConcreteOp::Adaptor adaptor,
    ...
    auto generic = d2m::GenericOp::create(
        ...
        [&, inputOperand, outputOperand](OpBuilder &builder, Location bodyLoc,
          ...
          auto inputBufferOp = tensor::EmptyOp::create(
              builder, bodyLoc, inputTensorType.getShape(),
              inputTensorType.getElementType());
          Value inputBuffer = inputBufferOp.getResult();
          Value input =
              d2m::RemoteLoadOp::create(builder,
          ...
          auto emptyOp = tensor::EmptyOp::create(
              builder, bodyLoc, outputTensorType.getShape(),
